...
RegisterNetEvent("CNC:joinRoundIfRoundIsGoingOn")
AddEventHandler("CNC:joinRoundIfRoundIsGoingOn", function()
    print("Join Round - Gamestate: " .. tostring(isRoundOngoing))
...
RegisterNetEvent("CNC:ClientUpdate:GameState")
AddEventHandler("CNC:ClientUpdate:GameState", function(gameState)
    print("setGamestate: " .. tostring(gameState))
    isRoundOngoing = gameState
end)